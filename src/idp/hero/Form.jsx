          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                required
                className=" indent-2 block w-full text-gray-800 rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-800 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
