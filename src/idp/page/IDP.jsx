...
const IDP = () => {
  ...
  return (
    <div className="relative container flex-1 w-full h-full  text-gray-100 mx-auto ">
      <div className="absolute min-h-screen h-full flex  top-0 w-full z-0 overflow-hidden">
